...
export default function ProfileSettingsForm({
    ...
    return (
        <section className="bg-white p-6 rounded-lg shadow-sm border space-y-4">
            ...
            <form action={updateProfileSettings} className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                <div>
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Public Accent Color</label>
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-xs text-gray-500 font-mono">{themeColor || "#3B82F6"}</span>
                    </div>
                </div>
