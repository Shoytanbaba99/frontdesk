...
export default function ProfileSettingsForm({ profile }: { profile: any }) {
    const [color, setColor] = useState(profile?.theme_color || "#2563EB");
    ...
    return (
        <section className="bg-white p-6 rounded-xl shadow-sm border space-y-4">
            ...
            <form action={updateProfileSettings} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Avatar Profile Photo URL</label>
                        <input
                            type="url"
                            name="avatar_url"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Cover Banner Image URL</label>
                        <input
                            type="url"
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Public Accent Color</label>
