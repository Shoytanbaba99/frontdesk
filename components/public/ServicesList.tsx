...
export default function ServicesList({ blocks, profileId, providerUsername, themeColor }: { blocks: any[], profileId: string, providerUsername?: string, themeColor: string }) {
    ...
    const filteredBlocks = useMemo(() => {
        return blocks.filter(block => {
            const matchesSearch = block.title.toLowerCase().includes(searchQuery.toLowerCase()) || (block.description && block.description.toLowerCase().includes(searchQuery.toLowerCase()));
